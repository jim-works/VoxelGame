...
public class Pool<T>
{
    ...
    public static Pool<GameObject> createEntityPool(GameObject prefab, World world, int initSize = 5, bool prefill = false)
    {
    ...
    public static Pool<GameObject> createGameObjectPool(GameObject prefab, int initSize = 5, bool prefill = false)
    {
        Pool<GameObject> pool = new Pool<GameObject>(
            () => UnityEngine.Object.Instantiate(prefab),
            g => g.activeInHierarchy,
